...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <title>Register | CyberAdmin</title>
  ...
  <body>
    <div class="cyber-card">
      ...
      <h2 style="font-family: var(--font-heading); font-size: 1.2rem; margin-bottom: 1.5rem;">REGISTER</h2>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="cyber-input-group">
          <label>Name</label>
          <input type="text" name="name" class="cyber-input" value="{{ old('name') }}" required autofocus />
        </div>
        
        <div class="cyber-input-group">
          <label>Email</label>
          <input type="email" name="email" class="cyber-input" value="{{ old('email') }}" required />
        </div>
        
        <div class="cyber-input-group">
          <label>Password</label>
          <input type="password" name="password" class="cyber-input" required autocomplete="new-password" />
        </div>
        
        <div class="cyber-input-group">
          <label>Confirm Password</label>
          <input type="password" name="password_confirmation" class="cyber-input" required autocomplete="new-password" />
        </div>
