...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <title>Reset Password | CyberAdmin</title>
  ...
  <body>
    <div class="cyber-card">
      ...
      <h2 style="font-family: var(--font-heading); font-size: 1.2rem; margin-bottom: 1.5rem;">RESET PASSWORD</h2>
      ...
      <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="cyber-input-group">
          <label>Email</label>
          <input type="email" name="email" class="cyber-input" value="{{ old('email', $request->email) }}" required autofocus />
        </div>
